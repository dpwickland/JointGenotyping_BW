...
*bash CombineGVCFs_BW.sh \<which reference assembly to use: hg19 or hg38> \<title to use for output directory> \<path to combined GVCFs> \<path to Delivery directory for final VCF output>*
