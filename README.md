...
## Introduction
This workflow for the Blue Waters supercomputer conducts joint genotyping on very large cohorts of GVCFs generated by GATK HaplotypeCaller. After several input preparation steps, it runs GATK's GenotypeGVCFs command on randomly selected subsamplings of various sizes from the larger cohort of single-sample GVCFs.
