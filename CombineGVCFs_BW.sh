...
##USAGE
#bash CombineGVCFs_BW.sh <which reference assembly to use: hg19 or hg38> <subsample directory containing samples_list directory generated by the previous command>
