...
##USAGE
#bash CombineGVCFs_BW.sh <which reference assembly to use: hg19 or hg38> <subsample directory containing samples_list directory>

##EXAMPLE COMMAND
#bash CombineGVCFs_BW.sh hg19 /mnt/c/scratch/sciteam/jacobrh/purge_exempt/ADSP_VarCallResults/ADSP_JointGenotyping/hg19/BWA-GATK_HC_defaults/Randomized_Subsamplings/BatchSize500/Subsample4_BWA

#bash CombineGVCFs_BW.sh hg19 /mnt/c/scratch/sciteam/jacobrh/purge_exempt/ADSP_VarCallResults/ADSP_JointGenotyping/hg19/Novoalign-GATK_HC_defaults/Randomized_Subsamplings/BatchSize500/Subsample4_Novoalign

#bash CombineGVCFs_BW.sh hg38 /mnt/c/scratch/sciteam/jacobrh/purge_exempt/ADSP_VarCallResults/ADSP_JointGenotyping/hg38/BWA-GATK_HC_defaults/Randomized_Subsamplings/BatchSize500/Subsample4_BWA
...
###CREATE APRUN SCRIPT FOR COMBINEGVCFS
echo "#!/bin/sh
